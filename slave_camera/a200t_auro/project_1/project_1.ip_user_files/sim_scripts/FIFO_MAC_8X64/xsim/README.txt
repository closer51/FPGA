...
#
# Generated by export_simulation on Mon Oct 13 22:17:01 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './FIFO_MAC_8X64.sh' script.

./FIFO_MAC_8X64.sh -reset_run
...
./FIFO_MAC_8X64.sh -noclean_files

For more information on the script, please type './FIFO_MAC_8X64.sh -help'.
