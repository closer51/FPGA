...
#
# Generated by export_simulation on Mon Oct 13 22:17:16 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './FIFO_ASYNC_11_64.sh' script.

./FIFO_ASYNC_11_64.sh -reset_run
...
./FIFO_ASYNC_11_64.sh -noclean_files

For more information on the script, please type './FIFO_ASYNC_11_64.sh -help'.
