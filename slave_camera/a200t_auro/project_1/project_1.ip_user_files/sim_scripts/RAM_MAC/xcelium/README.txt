...
#
# Generated by export_simulation on Mon Oct 13 22:17:04 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './RAM_MAC.sh' script.

./RAM_MAC.sh -reset_run
...
./RAM_MAC.sh -noclean_files

For more information on the script, please type './RAM_MAC.sh -help'.
