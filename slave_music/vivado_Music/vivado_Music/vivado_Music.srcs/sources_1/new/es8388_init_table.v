...
(
	...
	assign lut_size = 8'd19;	//WM8960 寄存器初始化数量
	...
	always @ (*) begin
		...
		rom[6 ][15:0] = {7'h05,9'h007};
		rom[7 ][15:0] = {7'h02,9'h17B}; //音量
		rom[8 ][15:0] = {7'h03,9'h17B};
        ...
        rom[16][15:0] = {7'h15,9'h1DF}; 
        rom[17][15:0] = {7'h16,9'h1DF}; //ADC
		rom[18][15:0] = {7'h1B,9'h005};
	end
	always @ (posedge clk)
	begin
		q <= rom[addr];
