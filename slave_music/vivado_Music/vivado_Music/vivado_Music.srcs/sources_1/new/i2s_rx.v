...
// reg [31:0] adcfifo_readdata_nofir;
// reg [1:0] state;
// reg [7:0] bit_cnt;      //位计数
...
// wire [31:0] data_samples_out;
// wire adc_data_valid;

// assign adcfifo_empty = ~adc_data_valid;
// interpolation_top interpolation_top_test
// (
//     .sys_clk(clk_48kmult256),                 //PLL分频后时钟     
//     .adcfifo_rdclk(adcfifo_rdclk),
//     .bclk(bclk),        
//     .sys_rst(reset_n),
//     .sample_devide(divi_data),
//     .data_valid(adcfifo_write),  
//     .data_in(adcfifo_writedata),
//     .data_ready(adc_data_valid),  
//     .data_out(data_samples_out)
// );

// filter_control filter_control_test(
//     .sys_clk(adcfifo_rdclk),
//     .sys_rst(reset_n),
//     .fir_select(fir_select),
//     .divi_data(divi_data),
//     .data_valid(adc_data_valid),
//     .data_in(data_samples_out),
//     .data_out(adcfifo_readdata)
// );
