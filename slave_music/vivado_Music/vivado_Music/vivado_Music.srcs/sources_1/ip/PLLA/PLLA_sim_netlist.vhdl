...
-- Date        : Mon Nov  3 03:11:22 2025
-- Host        : PC-1000-times running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top PLLA -prefix
--               PLLA_ PLLA_sim_netlist.vhdl
-- Design      : PLLA
...
end PLLA_PLLA_clk_wiz;

architecture STRUCTURE of PLLA_PLLA_clk_wiz is
...
entity PLLA is
  ...
  attribute NotValidForBitStream of PLLA : entity is true;
end PLLA;

architecture STRUCTURE of PLLA is
begin
inst: entity work.PLLA_PLLA_clk_wiz
     port map (
      clkin => clkin,
      clkout0 => clkout0,
      clkout1 => clkout1,
