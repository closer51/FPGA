...
#
# Generated by export_simulation on Wed Sep 17 03:07:18 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './ASYNC_FIFO_1X16.sh' script.

./ASYNC_FIFO_1X16.sh -reset_run
...
./ASYNC_FIFO_1X16.sh -noclean_files

For more information on the script, please type './ASYNC_FIFO_1X16.sh -help'.
