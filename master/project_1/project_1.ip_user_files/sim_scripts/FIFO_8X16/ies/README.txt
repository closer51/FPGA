...
#
# Generated by export_simulation on Sun Sep 21 17:06:06 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './FIFO_8X16.sh' script.

./FIFO_8X16.sh -reset_run
...
./FIFO_8X16.sh -noclean_files

For more information on the script, please type './FIFO_8X16.sh -help'.
