...
proc create_hier_cell_clk_map { parentCell nameHier } {
  ...
  connect_bd_net -net clk_map_aclk2_net [get_bd_pins S01_ACLK] [get_bd_pins aclk2] [get_bd_pins psr0/slowest_sync_clk] [get_bd_pins psr_aclk2/slowest_sync_clk]
