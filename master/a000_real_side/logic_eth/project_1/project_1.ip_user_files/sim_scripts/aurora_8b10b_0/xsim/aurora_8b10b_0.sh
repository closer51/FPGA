...
simulate()
{
  xsim aurora_8b10b_0 -key {Behavioral:sim_1:Functional:aurora_8b10b_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_48ac.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
