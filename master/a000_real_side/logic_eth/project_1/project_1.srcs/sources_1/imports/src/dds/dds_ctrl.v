...
begin
    if(i_rst)
        ...
        ro_fword <= r_shift_frq/50000000;//16+14=30    
     else 
        ro_fword <= ro_fword;
end
...
begin
    if(i_rst)
        ...
        r_dds_offset <= (i_dds_offset<<10)/375;//i_dds_offset/6000*2^14
    else 
...
begin
    if(i_rst)
        ...
        ro_pay_dds_data <= 14'h3fff-(ro_pay_dds_data_div_mul + r_dds_offset);
end
